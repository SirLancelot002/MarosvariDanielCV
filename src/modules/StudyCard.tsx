        ...
        <Link to={`/studies/${study.id}`} className="study-card">
          ...
          <div className="study-card__content">
            <div className="study-card__level" aria-label={`Level ${study.level} of 5`}>
              <p><span className="study-card__level-label"><a href='https://europass.europa.eu/en/description-eight-eqf-levels'>EQF {t("studies.level")}</a>:</span>
            ...
            <p className="study-card__period"><img src={calendarLogoImg} alt="" className="personal-data-icon" /> {formatStudyPeriod(study.startDate, study.endDate, lang)}</p>
